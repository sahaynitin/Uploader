...
@Tellybots.on_message(filters.private & filters.photo)
...
@Tellybots.on_message(filters.private & filters.command("delthumbnail"))
...
@Tellybots.on_message(filters.private & filters.command("viewthumbnail") )
